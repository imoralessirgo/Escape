...
public class OrthoOmniOrthoTests {
	 ...
	 */
	@ParameterizedTest
	@MethodSource("orthoOmniProvider")
	void orthoOmniTests(boolean expected, int x1, int y1, int x2, int y2) {
		assertEquals(expected,
				emg.move(emg.makeCoordinate(x1, y1), emg.makeCoordinate(x2, y2)));
	}

	static Stream<Arguments> orthoOmniProvider() {
		return Stream.of(
				// frog
				...
				Arguments.of(false, 18,15,16,15),
				//snail
