...
/**
 * This interface describes the behavior of the Escape game controller. Every instance of
 * an Escape game controller must implement this interface. The methods described here are
