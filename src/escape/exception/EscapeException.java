 ...
 * RuntimeException. This is simply convenience since these are unchecked. We expect
 * exceptions to be meaningful, so any new exception types should be a subclass of this
 * class.
 * 
 * @version Mar 28, 2020
 */
